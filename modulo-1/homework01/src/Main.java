public class Main {
    public static void main(String[] args) {
        ...
        Cliente clienteJhennyfer = new Cliente("Jhennyfer Silva Sobrinho",
                "056872651-04",new Contato[]{contatoJhennyfer}, new Endereco[]{enderecoJhennyfer});
        ...
        Cliente clienteMaria = new Cliente("Maria Fernandes de Lima", "85568901833",  new Contato[]{contatoMaria}, new Endereco[]{enderecoMaria});
